...
{
    [Header("Stress Settings")] public float stressAuraTimer;
    public float stressAuraDamage;
    public float attackCooldown;
    public float attackRange;
    public float stressHitDamage;
    [Header("Idle Settings")] public float averageIdleDuration;
    public float idleDurationDelta;
    [Header("Roaming Settings")] public float roamingMovementSpeed;
    public float averageRoamingDuration;
    public float roamingDurationDelta;
    [Header("Chase Settings")] public float chaseMovementSpeed;
    public float chaseScanIntervalTimer;
    public float chaseOffsetRadius;
    [Header("Aggro Settings")] public float aggroRangeRadius;
